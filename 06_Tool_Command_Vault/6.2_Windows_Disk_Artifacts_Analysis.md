# 6.2 Windows Disk Artifact Analysis
...
*Evidence: Automates detection of Password Spraying, Obfuscation, and Emotet in EVTX files.*

**Parse an exported EVTX file:**
```powershell
.\DeepBlue.ps1 "<PATH_TO_EVTX_FILE>"
# Example: .\DeepBlue.ps1 "Z:\Evidence\Logs\Security.evtx"
```
