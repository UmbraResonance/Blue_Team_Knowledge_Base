# 6.6 Network Analysis Workflows (CLI & Extraction)
...
> **Reference:** For specific filter syntax (e.g., HTTP/SMB/Kerberos), see `01_Hunting_Cheatsheets/1.3_Network_Protocol_Filters.csv`.
