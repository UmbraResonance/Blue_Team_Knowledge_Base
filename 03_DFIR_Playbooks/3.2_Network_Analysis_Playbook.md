...
* **Tool Vault Link:** Use [`6.6_Network_Traffic_Analysis`](../06_Tool_Command_Vault/6.7_Network_Traffic_Analysis.md) for Tshark protocol summary commands.
...
* **Tool Vault Link:** Use [`6.6_Network_Traffic_Analysis`](../06_Tool_Command_Vault/6.7_Network_Traffic_Analysis.md) for **NetworkMiner** automated extraction or Wireshark `Export Objects`.
...
* **[ ]** Did I confirm the system timezone via [`1.4_Forensics_Artifacts_Map`](../01_Hunting_Cheatsheets/1.5_Forensics_Artifacts_Map.csv) to align the PCAP with host logs?
* **[ ]** Have I distinguished between legitimate automated traffic and adversary C2?
* **[ ]** If the PCAP is >500MB, did I use [`6.6`](../06_Tool_Command_Vault/6.7_Network_Traffic_Analysis.md) Tshark commands for initial slicing?
