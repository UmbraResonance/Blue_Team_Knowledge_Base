...
### Hunting Tip: The "IP vs Hostname" Signal
- **Scenario:** RDP logon failure with NO Event 4771 but high volume of Event 4776.
- **Root Cause:** Use of IP Address instead of Hostname triggers mandatory NTLM fallback, bypassing Kerberos SPN logic.
- **Detection Value:** High-confidence indicator of automated scanners or legacy scripts that bypass domain DNS resolution.
